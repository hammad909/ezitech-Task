...
import com.oneasad.googleloginjetpackcompose.ProfileEnum
                ...
                result.fold( // It allows you to specify actions for both success and failure cases of the operation, making it easy to manage the different outcomes.
                    onSuccess = { authResult ->
                        ...
                        if (currentUser != null) {
                            ...
                            Log.d("Current","the email is " + (currentUser.email))
                            ...
                            if(currentUser.email != "hammadullah6455@gmail.com")
                            { navController.navigate(ProfileEnum.Profile.name)
                            } else {
                                navController.navigate(ProfileEnum.Admin.name)
                            }
                        }
                    },
                    onFailure = { e ->
