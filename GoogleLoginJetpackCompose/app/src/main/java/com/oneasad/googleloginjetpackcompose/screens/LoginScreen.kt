...
fun LoginScreen(
    ...
    Box(
        ...
        Image(
            painter = painterResource(id = R.drawable.sq1),
...
fun InputText(
    ...
    TextField(
        ...
        placeholder = { Text(text = placeholder, color = Purple) },
        leadingIcon = { Icon(
            imageVector = imageVector,
            contentDescription = null,
            tint = Purple
...
fun LoginFooter(
    ...
    Column (
        ...
        Row {
            LogoImage( onGoogleSignInClick = onGoogleSignInClick, logo = R.drawable.gmail)
            LogoImage( onGoogleSignInClick = onGoogleSignInClick, logo = R.drawable.facebook)
            LogoImage( onGoogleSignInClick = onGoogleSignInClick, logo = R.drawable.twitter)
        }
    }
}
